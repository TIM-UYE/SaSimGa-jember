        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 min-h-[700px]">
            <div class="relative hidden lg:block bg-cover bg-center" style="background-image: url('{{ asset('images/login/login.jpeg') }}');">
                ...
                <div class="absolute inset-0 flex flex-col items-center justify-center px-8">
                    ...
                    <div class="text-center text-white max-w-xs">
                        ...
                        <p class="mt-4 text-sm text-slate-200">Buat akun baru untuk mengelola menu dan pesanan dengan mudah.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white px-8 py-10 sm:px-12 sm:py-12 flex items-center justify-center">
                <div class="w-full max-w-md">
                    <div class="mb-10">
                        <h1 class="text-3xl font-bold text-orange-600">Daftar</h1>
                        <p class="mt-3 text-sm text-slate-500">Isi data berikut untuk membuat akun baru.</p>
                    </div>
                    ...
                    <form action="{{ route('register') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input id="password_confirmation" name="password_confirmation" type="password"
                                ...
                                required
                                class="mt-2 w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-orange-400 focus:ring-4 focus:ring-orange-200 @error('password_confirmation') border-red-400 ring-red-200 @enderror" />
                        </div>
                    ...
                    <div class="mt-8 text-sm text-slate-500 text-center">
                        Sudah punya akun?
                        <a href="{{ route('login') }}" class="font-semibold text-orange-600 hover:text-orange-700">Masuk sekarang</a>
                    </div>
                </div>
            </div>
        </div>
