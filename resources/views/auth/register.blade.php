            ...
            <div class="p-8">
                ...
                <form action="{{ route('register') }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <input class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent @error('nama') border-red-500 @enderror"
                            type="text"
                            id="nama"
                            name="nama"
                            value="{{ old('nama') }}"
                    ...
                    <div class="mb-6">
                        ...
                        <input class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent @error('password_confirmation') border-red-500 @enderror"
                            type="password"
