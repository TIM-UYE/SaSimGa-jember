        ...
        <form action="{{ route('admin.menu-specials.store') }}" method="POST" enctype="multipart/form-data" id="specialForm">
            ...
            <div class="grid gap-4 md:grid-cols-2">
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="short_description" id="short_description" rows="5" class="w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-800 focus:border-orange-400 focus:ring-orange-200 focus:ring-2" placeholder="Deskripsi singkat mengenai menu special.">{{ old('short_description') }}</textarea>
                    </div>
                    ...
                    <div id="banner-preview" class="hidden">
                        ...
                        <img id="banner-preview-img" src="" alt="Banner Preview" class="h-64 w-full rounded-3xl object-cover ring-1 ring-slate-200">
                    </div>
                </div>
                ...
                <div class="space-y-4">
                    <div class="rounded-2xl border border-slate-200 bg-slate-50 p-5">
                        <label class="flex items-center gap-3">
                            <input type="checkbox" name="is_active" id="is_active" value="1" class="h-4 w-4 rounded border-slate-300 text-orange-500 focus:ring-orange-500">
            ...
            <div class="rounded-3xl border border-slate-200 bg-slate-50 p-5 mt-6">
                ...
                <div class="mt-4 overflow-x-auto">
                    <table class="w-full min-w-[760px] text-sm text-slate-600">
                        ...
                        <tbody id="variantTableBody" class="divide-y divide-slate-200">
                            <tr id="noVariantsRow">
                                <td colspan="5" class="py-10 text-center text-slate-500">Belum ada varian. Klik tombol Tambah Varian untuk membuat varian baru.</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
...
<div
    id="itemModal"
    class="fixed inset-0 z-[9999] hidden items-center justify-center overflow-y-auto bg-black/70 p-4"
>
    <div class="relative w-full max-w-3xl rounded-3xl bg-slate-950 shadow-2xl ring-1 ring-slate-800">
        ...
        <div class="flex items-center justify-between border-b border-slate-800 px-6 py-4">
            <div>
                <h3 class="text-xl font-semibold text-white" id="itemModalTitle">
                    Tambah Varian Menu
                </h3>

                <p class="text-sm text-slate-400">
                    Isi detail varian spesial dengan harga dan gambar.
                </p>
            </div>
        ...
        <form
            ...
            onsubmit="event.preventDefault(); saveVariant();"
        >
            ...
            <div id="item-image-preview" class="hidden">
                ...
                <img
                    ...
                    src=""
                    alt="Preview"
                    class="h-56 w-full rounded-3xl object-cover ring-1 ring-slate-700"
                >
            </div>
            ...
            <div class="flex flex-col gap-3 pt-4 sm:flex-row sm:justify-end">
                ...
                <button
                    type="button"
                    onclick="closeItemModal()"
                    class="rounded-2xl border border-slate-700 px-6 py-3 text-sm font-semibold text-white transition hover:bg-slate-800"
                >
                    Batal
                </button>
                ...
                <button
                    type="submit"
                    class="rounded-2xl bg-orange-500 px-6 py-3 text-sm font-semibold text-white transition hover:bg-orange-600"
                >
                    Simpan Varian
                </button>
            </div>
...
<script>
    ...
    function openItemModal(index = null) {
        ...
        document.getElementById('item_is_available').checked =
            item ? item.is_available : true;

        document.getElementById('item_image').value = '';

        const preview =
            document.getElementById('item-image-preview');

        const previewImg =
            document.getElementById('item-preview-img');
    ...
    function saveVariant() {
        ...
        const price =
            Number(document.getElementById('item_price').value);

        const description =
            document.getElementById('item_description').value.trim();
                ...
                <td class="px-4 py-4">
                    <div class="flex justify-end gap-2">
                        ...
                        <button
                            ...
                            class="rounded-xl bg-slate-800 px-4 py-2 text-xs font-semibold text-white"
                        >
                            Edit
                        </button>
                        ...
                        <button
                            ...
                            class="rounded-xl bg-red-500 px-4 py-2 text-xs font-semibold text-white"
                        >
                            Hapus
                        </button>
                    </div>
