    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            @foreach ($menus as $menu)
                <div class="group bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition duration-300 menu-card"
                    ...
                    <div class="relative overflow-hidden">
                        ...
                        <div class="absolute inset-x-0 bottom-0 bg-linear-to-t from-black/70 to-transparent p-4">
                    ...
                    <div class="p-5">
                        <h3 class="font-semibold text-xl text-slate-900 mb-2">{{ $menu->nama_menu }}</h3>
                        <p class="text-sm text-slate-500 mb-4 leading-relaxed" style="min-height: 3rem;">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="flex gap-3">
                        <button id="modalOrderBtn" class="flex-1 bg-orange-500 text-white py-3 rounded-lg font-bold hover:bg-orange-600 transition">
