    ...
    <div class="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div class="max-w-2xl mx-auto text-center mb-16 reveal">
            ...
            <p class="text-zinc-400 text-base leading-relaxed">
                Pesan tempat duduk favorit Anda bersama keluarga dan teman.
            </p>
        </div>

        {{-- Card Utama --}}
        <div
            class="grid md:grid-cols-5 min-h-[450px] md:min-h-[500px] lg:min-h-[550px]
bg-zinc-900/50 rounded-3xl overflow-hidden border border-zinc-800
shadow-2xl shadow-black/50 reveal">

            {{-- Image Panel (3 kolom) --}}
            <div class="md:col-span-2 relative min-h-[300px] md:h-full overflow-hidden">
                ...
                <img src="{{ asset('images/reservasi/sate.jpg') }}" alt="Sate Simpang Tiga"
                    class="absolute inset-0 w-full h-full object-cover object-center transition-all duration-700 hover:scale-110">
